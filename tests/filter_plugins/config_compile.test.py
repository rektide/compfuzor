...
def test_compile():
    ...
    check("shared remote implementation", "config-remote.ts" in names, True)
    check("remote wrapper", "config-remote-mcp.ts" in names, True)
    check("inferred remote wrapper", "config-remote-zimfw.conf.d.ts" in names, True)
